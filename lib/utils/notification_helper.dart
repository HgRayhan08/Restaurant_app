import 'dart:convert';
import 'dart:math';
import 'package:final_project_restaurant_app/common/navigasi_custom.dart';
...
class NotificationHelper {
  ...
  Future<void> showNotification(
      ...
      ListRestaurantResponse restaurant) async {
    var channelId = "1";
    var channelName = "channel_01";
    var channelDescription = "Restaurant Recomended";
    ...
    var titlleRestaurant = "<b>${random.name}</b>";

    await flutterLocalNotificationsPlugin.show(
        0, titleNotification, titlleRestaurant, platformChannelSpecifics,
